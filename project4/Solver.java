...
public class Solver {
    private LinkedStack<Board> solution;   // Linking the board
    private int moves = 0;                     // Number of moves in the game
    
    // Helper search node class.
    private class SearchNode {
        private Board board;    // the board
        private int moves;      // amount of movies
        private SearchNode previous;  // stores the number of pervious moves you made
