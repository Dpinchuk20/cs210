...
public class BrutePointST<Value> implements PointST<Value> {
    private RedBlackBinarySearchTreeST<Point2D, Value> bst; // symbol table
    ...
    public void put(Point2D p, Value val) {
        ...
        if (val == null) { throw new NullPointerException("null argument"); }
        bst.put(p, val);
    }
    ...
    public Iterable<Point2D> range(RectHV rect) {
        if (isEmpty()) { throw new NullPointerException("null argument"); }
